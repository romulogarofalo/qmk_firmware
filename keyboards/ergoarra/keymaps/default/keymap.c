...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERT] = LAYOUT(
		...
		KC_LCTL,  KC_APP, KC_LALT, SYMB_L,  OTHER_L,                  
			      KC_SPC, KC_BSPC, KC_ENT,  KC_DEL,  KC_HOME,  KC_END,
		// rigth rand
		OTHER_L,   KC_6,   KC_7,      KC_8,    KC_9,   KC_0,     KC_BACKSPACE, 
		KC_GRV,    KC_Y,   KC_U,      KC_I,    KC_O,   KC_P,     KC_LBRC, 
		           KC_H,   KC_J,      KC_K,    KC_L,   KC_SCLN,  KC_QUOT,
		KC_RBRC,   KC_N,   KC_M,      KC_COMM, KC_DOT, KC_SLSH,  KC_RSFT,
		                   KC_LEFT,   KC_DOWN, KC_UP,  KC_RIGHT, KC_RGHT,
		KC_HOME,   KC_END, KC_LSFT,   KC_DEL, KC_ENT,  KC_BSPC
	),
	...
	[_OTHER] = LAYOUT(
		// left rand
		QK_BOOT, QK_RBT,  KC_2,   KC_3,   KC_4,    KC_5,    KC_SPC,
		KC_TAB,  KC_Q,    KC_W,   KC_E,   KC_R,    KC_T,    KC_SPC,
		KC_LSFT, KC_A,    KC_S,   KC_D,   KC_F,    KC_G,           
		KC_LCTL, KC_Z,    KC_X,   KC_C,   KC_V,    KC_B,    KC_SPC,
		KC_SPC,  KC_SPC,  KC_SPC, KC_SPC, KC_SPC,                  
